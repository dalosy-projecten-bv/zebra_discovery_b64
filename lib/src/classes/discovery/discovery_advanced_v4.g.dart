...
Map<String, dynamic> _$DiscoveryAdvancedV4ToJson(
    ...
    <String, dynamic>{
      ...
      'jsonPort': instance.jsonPort.toJson(),
      'linkOsMajorVer': instance.linkOsMajorVer.toJson(),
      'linkOsMinorVer': instance.linkOsMinorVer.toJson(),
      'avsIniVersion': instance.avsIniVersion.toJson(),
      'processorId': instance.processorId.toJson(),
      'tlsRawPort': instance.tlsRawPort.toJson(),
      'tlsJsonPort': instance.tlsJsonPort.toJson(),
      'wired8021XSecuritySetting': instance.wired8021XSecuritySetting.toJson(),
    };
