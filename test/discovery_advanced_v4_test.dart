...
void main() {
  //This is a real string, received from an actual device, only the version is changed to 4
  ...
  group('Test advancedV4', () {
    test('Decode an advancedV4 message', () {
      ...
      expect(discovery.discoveryDataMap['ADVANCED_DISCOVERY_VER'], '4');
      ...
      final jsonExpected = jsonDecode(
        testResources('discovery_advanced_v4.json'),
      );
